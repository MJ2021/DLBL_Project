...
csv_path = '/home/Drivessd2tb/dlbl_data/Mohit/FEATURES_FINAL/csv_files_with_white_filter_for_json/003128CN__20240214_131534.csv'
...
def main():
    for csv in csv_path:
        ...
        json_path = '/home/Drivessd2tb/dlbl_data/Mohit/FEATURES_FINAL/json_files_with_white_filter/'+ slide_name +'.json'
        ...
        try:
            ...
            # save_annotation_qupath(TX,TY,BX,BY,json_path)
