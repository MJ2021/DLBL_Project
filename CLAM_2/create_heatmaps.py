...
if __name__ == '__main__':
    ...
    for i in tqdm(range(len(process_stack))):
        ...
        features_path = os.path.join('/home/Drivessd2tb/Mohit2_new/Features_new/pt_files/', slide_id+'.pt')
        h5_path = os.path.join('/home/Drivessd2tb/Mohit2_new/Features_new/h5_files/', slide_id+'.h5')
        ...
        if not os.path.isfile(features_path):
            print("Features Path Does Not Exist")
